...
class Settings(BaseSettings):
    ...
    data_dir: str = Field(
        default="./All_Whispers_message",
        description="Data directory containing PDF documents",
    )
    ...
    langchain_project: str = Field(
        default="heart-speaks", description="LangSmith Project Name"
    )
    ...
    chunk_size: int = Field(
        default=1000, description="Chunk size for document splitting"
    )
